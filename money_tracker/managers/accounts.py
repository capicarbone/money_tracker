...
from money_tracker.models import Account, HIGH_LIQUIDITY_TYPE, ACCOUNT_TYPES, CHECKING_ACCOUNT_TYPE, LIABILITY_ACCOUNT_TYPE
...
class AccountsManager:
    ...
    def create_account(self, name, account_type: str, liquidity_type = HIGH_LIQUIDITY_TYPE) -> Account:
